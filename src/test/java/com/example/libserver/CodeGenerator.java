...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        //绝对路径
        String projectPath = "C:\\MineApp\\WebProject\\Lib-Server";
        //生成文件的目录
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/lib_database?serverTimezone=GMT%2B8");
